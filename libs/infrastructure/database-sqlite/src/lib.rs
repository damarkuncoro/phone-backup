...
impl SnapshotRepositoryPort for SqliteRepository {
    ...
    fn save_structured_data_ref(
        ...
        self.snapshots()
            .save_structured_data_ref(snapshot_id, data_type, object_id)
    }
...
impl FileRepositoryPort for SqliteRepository {
    ...
    fn link_files_to_snapshot_batch(
        ...
        self.files()
            .link_files_to_snapshot_batch(snapshot_id, file_ids)
    }
    ...
    fn save_physical_object(
        ...
        self.files().save_physical_object(
            chunk_id,
            object_hash,
            storage_key,
            stored_size,
    ...
    fn save_file_chunk(
        ...
        self.files()
            .save_file_chunk(file_id, chunk_id, offset, length, sequence)
    }
...
impl CallLogRepositoryPort for SqliteRepository {
    ...
    fn get_snapshot_call_logs(
        &self,
        snapshot_id: &SnapshotId,
    ) -> anyhow::Result<Vec<domain::CallLog>> {
