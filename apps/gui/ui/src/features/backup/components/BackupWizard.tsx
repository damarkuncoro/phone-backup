            ...
            <div className="flex-1 overflow-y-auto bg-slate-50/50 custom-scrollbar p-6">
              {isCalculating ? (
                <div className="h-full flex flex-col items-center justify-center gap-4 py-20 text-slate-400">
                  ...
                  <p className="text-xs font-black uppercase tracking-widest">Menganalisis Sistem Berkas Ponsel...</p>
                </div>
            ...
            <div className="p-6 md:p-8 border-t border-slate-100 bg-white shrink-0 flex justify-between items-center">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="px-8 py-3.5 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl font-black text-xs uppercase tracking-wider shadow-xl shadow-slate-200 transition-all flex items-center gap-2.5 active:scale-95"
                >
