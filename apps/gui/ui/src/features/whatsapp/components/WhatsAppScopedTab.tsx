...
export function WhatsAppScopedTab() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-white/10">
        <div>
          <h2 className="text-lg font-black text-white">Scoped Storage Media Matrix</h2>
          <p className="text-xs text-slate-400 mt-0.5">
            Pindai struktur media WhatsApp dari partisi internal Android 11–15 & Android Legacy.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-bold px-4 py-2 rounded-xl text-xs shadow-lg shadow-emerald-600/20 transition-all"
          >
          ...
          {previewHtml && (
            <button
              ...
              className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-4 py-2 rounded-xl text-xs shadow-lg shadow-indigo-600/20 transition-all"
            >
