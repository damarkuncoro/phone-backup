...
-   **Encrypted Metadata Engine**: SQLCipher AES-256 database-level encryption with Argon2id Key Derivation Function (`derive_database_key`).
-   **Strict Workspace Test & Source Isolation**: 100% pure production `src/` directories with dedicated `tests/` integration suites across all crates.
